...
import com.wiselap.accounts.expense.ExpenseReturnModel;
...
public class ExpenseAdapter extends RecyclerView.Adapter<ExpenseAdapter.ExpenseHolder> {
    ...
    public void onBindViewHolder(@NonNull ExpenseHolder expenseHolder, int i) {
            ...
            expenseHolder.expenseamount.setText(expenseModel.getExpense_amount());
            expenseHolder.expensetype.setText(expenseModel.getExpenseTypeName());
